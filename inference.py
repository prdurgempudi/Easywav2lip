...
parser.add_argument('--mouth_tracking', type=str, default=True, 
help='Tracks the mouth in every frame for the mask')

parser.add_argument('--mask_dilation', default=90, type=float,
            help='size of mask around mouth', required=False)

parser.add_argument('--mask_feathering', default=91, type=int,
